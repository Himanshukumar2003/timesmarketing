      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-12 ">
          <div className="container max-w-8xl mx-auto">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="overflow-x-auto">
                <p className="text-sm text-gray-500 mt-4">Load capacity [kg]</p>
                <table className="min-w-full border border-gray-300">
                  ...
                  <tbody>
                    {[
                      ["I lKr", "2.85", "2.6", "", "", "", "", ""],
                      ["I IHT", "3.0", "3.0", "", "", "", "", ""],
                      ["II lKr", "4.65", "4.6", "2.85", "1.62", "", "", ""],
                      ["II IHT", "6.0", "5.0", "3.0", "2.0", "", "", ""],
                      [
                        "II-L lKr",
                        "7.41",
                        "7.01",
                      ...
                      ["II-L IHT", "8.0", "8.0", "7.0", "4.0", "2.0", "", ""],
                      ["II lKr", "7.75", "7.75", "7.45", "6.0", "3.5", "", ""],
                      ["II IHT", "8.0", "8.0", "8.0", "7.0", "4.0", "", ""],
                      ["II-H lKr", "", "10.5", "10.5", "9.3", "6.5", "", ""],
                      ["II-H IHT", "", "14.0", "13.0", "11.0", "7.0", "", ""],
                      ["III lKr", "", "", "", "8.4", "6.3", "4.3", "3.6"],
                      ["III IHT", "", "", "", "9.0", "7.0", "5.0", "4.0"],
                    ].map((row, idx) => (
                      <tr key={idx}>
                        {row.map((cell, i) => (
                          <td
          ...
          <div className="px-4 md:px-10 py-10 text-gray-800 max-w-8xl mx-auto space-y-10">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-center">Accessories</h2>
            <div className="flex justify-center mb-6 items-center">
            <div className="max-w-8xl mx-auto">
              ...
              <p className="text-justify leading-relaxed">
                The Demag KBK trolley limit stop improves the modularity of the
                light crane system. Buffers can be very easily installed at any
                time, which enables KBK Steel (I, II, II-H) and Aluline (I, 22)
                crane equipment to be buffered along the crane girder or crane
                runway. A temporary or long-term limit of the long and
                cross-travel motions can be installed in no time at all. The
                trolley limit stop is fitted with Demag cellular plastic buffers
                and can be installed under the rail. The benefit: The noise
                level in the event of unavoidable collisions can be reduced.
              </p>
            </div>
            </div>
            ...
            <div className="space-y-6 max-w-4xl">
              <p className="text-justify leading-relaxed">
                Two variants of the trolley limit stop can be supplied. The
                difference lies in the time frame for use. Travel along the
                crane runway or girder can be limited in the long term using the
                bolted variant. They can be installed at variable positions
                along the rails.
              </p>
              ...
              <p>The variant with a lever is also suitable for variable installation, but it can be released and repositioned more quickly and easily thanks to the lever. Temporary limit stops for the long and cross-travel motions can be easily installed in this way. For example, this may be needed to close the end of a track, to fix a crane or trolley in position or to secure the crane for installation or service work.</p>
