...
tabHeading:"The benefits at a glance",
...
},
 {
    ...
    summary: {
      title: "A compact solution tailored to meet your needs for every drive application",
      description:
  ...
  list:[
    {heading:"W10 to W50 hypoid gearboxes for particularly smooth operation",
    ...
    technicalData: {
      ...
      gearboxes: [
        ...
        },
        {
          size: "W20",
          torque: 200,
          ratios: { "2-stage": "5.45 - 90.1", "3-stage": "97.1 - 369", "4-stage": null },
        },
        {
          size: "W30",
          torque: 330,
          ratios: { "2-stage": "3.73 - 90.1", "3-stage": "107 - 369", "4-stage": null },
        },
        {
          size: "W40",
          torque: 500,
          ratios: { "2-stage": "3.87 - 90.8", "3-stage": "99.6 - 371", "4-stage": null },
        },
        {
          size: "W50",
          torque: 800,
          ratios: { "2-stage": "4.94 - 94.3", "3-stage": "99.9 - 386", "4-stage": null },
        },
        {
          size: "W60",
          torque: 1350,
          ratios: { "2-stage": null, "3-stage": "12.6 - 95.1", "4-stage": "113 - 388" },
        },
        {
          size: "W70",
          torque: 2500,
          ratios: { "2-stage": null, "3-stage": "13.7 - 102", "4-stage": "113 - 399" },
        },
        {
          size: "W80",
          torque: 4000,
          ratios: { "2-stage": null, "3-stage": "15.3 - 113", "4-stage": "126 - 441" },
        },
        {
          size: "W90",
          torque: 7000,
          ratios: { "2-stage": null, "3-stage": "15.9 - 111", "4-stage": "126 - 434" },
        },
        {
          size: "W100",
          torque: 12000,
          ratios: { "2-stage": null, "3-stage": "16.5 - 113", "4-stage": "121 - 485" },
        },
      ],
      housing: {
        "W10-W40": "Aluminium",
  ...
  },
{
    ...
    StrongMotor: {
        ...
        features: ["Motor output up to 45 kW",
           " 2, 4, 6 or 8 poles",
    ...
    featuresAndAccessories: {
      ...
      gearedMotors: {
        ...
        compatibility: {
          "A offset gearboxes": [true, true, true, true, true, true, true, true],
          "W angular gearboxes": [true, true, true, true, true, true, true, true],
          "D helical gearboxes": [false, false, true, true, true, true, true, true]
        },
        notes: {
          "Mounting flange": "Only for sizes D11 - D41",
          "Gearbox venting": "Standard for size 50",
  ...
  return (
    ...
    <div className="p-6">
      <Container maxWidth="md">
        <h2 className=" text-5xl font-bold text-gray-700">{selectedItem.summary.title}</h2>
      ...
      <Accordion defaultExpanded>
        ...
        <AccordionDetails>
          ...
          <ul className="list-disc list-inside">
            {selectedItem.productInformation.maximumFlexibility.map((item, i) => (
              <li key={i}>{item}</li>
            ))}
          </ul>
          {selectedItem.productInformation.img && selectedItem.productInformation.img.map((item, index) => (
          ...
          {selectedItem.productInformation.list && selectedItem.productInformation.list.map((item, index) => (
            <div className="" key={index}>
          ...
          <div className="mt-4">
            <h3 className="text-2xl font-bold my-4 text-[#676f77] mb-4">
              {selectedItem.productInformation.onlineConfiguration && selectedItem.productInformation.onlineConfiguration.heading}
            </h3>
            <ul className="list-disc list-inside">
              {selectedItem.productInformation.onlineConfiguration && selectedItem.productInformation.onlineConfiguration.features.map(
                (item, i) => (
                  <li key={i}>{item}</li>
                )
              )}
            ...
            <a
              href={selectedItem.productInformation.onlineConfiguration && selectedItem.productInformation.onlineConfiguration.link}
              target="_blank"
        ...
        <AccordionDetails>
          ...
          <table className="table-auto w-full border border-gray-300 mt-4 text-sm text-left shadow-sm rounded-lg overflow-hidden">
            <thead className="bg-gray-100 text-gray-700 uppercase tracking-wide">
              <tr>
                {selectedItem.technicalData.tableHeadings.map((heading, index) => (
    ...
    >
      ...
      {g.ratios["4-stage"] && (
        <td className="border border-gray-300 px-4 py-2">
          ...
          <div className="mt-2">
            <ul>
              {selectedItem.technicalData.housing && Object.entries(selectedItem.technicalData.housing).map(
                ([key, value]) => (
         ...
         {selectedItem.technicalData.img && <Image src={selectedItem.technicalData.img} alt="" width={100} height={100} layout="responsive" className="w-100 object-contain mb-4" ></Image>}
          <ul className="list-disc list-inside">
            {selectedItem.technicalData.description && data.technicalData.description.map((item, index)=>(
          ...
          <table className="table-auto w-full border border-gray-300 mt-6 text-sm text-left shadow-sm rounded-lg overflow-hidden">
            <thead className="bg-gray-100 text-gray-700 uppercase tracking-wide">
              <tr>
                ...
                {Object.keys(
                  selectedItem.featuresAndAccessories.gearedMotors.compatibility
                ).map((k) => (
                  <th
