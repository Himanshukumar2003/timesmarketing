      ...
      <div className="max-w-5xl mx-auto">
        ...
        {submitted ? (
          <div className="p-6 bg-green-50 rounded-md text-center">
            ...
            <button onClick={resetForm} className="mt-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
              Submit Another Form
            </button>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[ 'firstName', 'lastName', 'company', 'street', 'zipCode', 'townCity', 'email', 'telephone', 'country'].map((field) => (
            ...
            <div className="mt-6 form-group">
              <div className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                ...
                <div className="space-y-1 leading-none">
                  <label htmlFor="termsAccepted" className="block text-sm font-medium text-gray-700">
                    Terms of use & data protection / data transmission <span className="text-red-500">*</span>
                  </label>
                  <p className="text-sm text-gray-500">
                    ...
                    <br />
                    I consent to data processing in accordance with the privacy policy.
                    <br />
                    I can revoke consent anytime and understand my data may be shared with external partners.
                  </p>
            ...
            <div className="mt-6">
<button type="submit" className="flex rounded-sm mt-4 items-center  btn">
