        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8 text-center">
              ...
              operation and maximum safety. As basic hoist units for integration
              into plant and machinery or as lifting solutions with electronic
              controls that are optimized for crane applications, with our wide
              range of rope hoists we offer the optimum solution to meet our
              customers specific requirements for efficiently lifting loads
        ...
        <div className="container mx-auto px-4">
          <div className="space-y-4 text-gray-600 text-center">
            <p>
              ...
              components for a crane set or as lifting solutions with electronic
              controls that are optimised for crane applications. With our large
              portfolio of rope hoists and hoist units, we offer the best
              possible solution for your specific needs: cost-effective lifting
              equipment for loads up to 100 t.
            </p>
            ...
            <p className="">
              ...
              their lifting force with load capacities of between 1 t and 100 t.
              Depending on your application and specific needs, you can choose
              from a wide variety of models: from standard rope hoists in the
              lower load capacity range to special rope hoist designs with
              additional system components in the upper load capacity range.
            </p>
            <p>
              In addition, we offer various assemblies that can extend the
              lifting height. This can be achieved by mounting the hoist unit or
              rope winch on the side of the crane. The modular designs of our
              electric rope hoists are hard to beat in terms of lifting force,
              material quality and versatility – always with a view to
