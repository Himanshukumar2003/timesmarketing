      ...
      <div>
        <div className="bg-[#E3BC17] rounded-lg mx-auto max-w-3xl p-8 shadow-lg mb-[-110px] relative z-20">
          <div className="text-white flex flex-col items-center text-center">
            ...
            <Link
              href="/contact"
              className="bg-white mt-4 text-[#E3BC17] px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-100 transition"
            >
              Get in Touch
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-white text-sm">
                ...
                <p>
                  Services:
                  <span className="font-semibold"> +91 9810901759</span>
                </p>
